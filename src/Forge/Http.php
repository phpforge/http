 ...
 * Http Protocol
 *
 * Http Protocol, at this stage just hosting response codes for Application
 *
 * @see http://www.w3.org/Protocols/rfc2616/rfc2616-sec6.html#sec6
 * 
 * @author     Benjamin Charles Tehan <benjamin.tehan@devforge.net>
 * @version    $Id:$
 * @copyright  Copyright (c) 2013 devforge.net All rights reserved.
 */
class Http {
